    ...
    return (
      ...
      <div className={styles.container}>
        ...
        <form className={styles.formContainer} action="mailto: scrum-bkk@gmail.com" method="POST" enctype="text/plain">
          <label className={styles.label} for="name" minlength="3" required>Name:</label>
          <input className={styles.input} id='name' type="text" placeholder='Insert your name...'/>
          <label className={styles.label} for="name" minlength="6">Phone:</label>
          <input className={styles.input}  id='name' type="text" placeholder='Insert your phone...'/>
